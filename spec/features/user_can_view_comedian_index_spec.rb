...
RSpec.describe 'User visits the comedians show page' do
  it 'Shows a list of comdians' do
    com_1 = Comedian.create(name: "steve", city: "town town", age: 54)
    com_2 = Comedian.create(name: "andrew", city: "town wown", age: 43)
    com_3 = Comedian.create(name: "harvey", city: "town pown", age: 23)
